...
\title{DSH-Add Your Own Title}
%Add the authors name alphabetically!
\author{first name
\textsuperscript{1}, second name\textsuperscript{2, 3}, third name\textsuperscript{4},\\
%\vspace{0pt}
\\
\textsuperscript{1}Your student number,  \textsuperscript{2} Your student number \textsuperscript{3} your student number \\
\texttt{\{first name, second name, \& third name\}@student.uni.lu} \\ %in case your adding Lu email address use this template and if you want to add different email address from your coauthor use the following template. 
...
\maketitle
\begin{abstract}
This is the template for your final report. 
...
\begin{table}[!h]
\centering
\caption{The caption needs to be short and informative},\label{tab:collab}
\begin{tabular}{|l|l|l|}
\hline
                & \multicolumn{2}{l|}{\textbf{Task}} \\ \hline
\textbf{Name 1} & \multicolumn{2}{l|}{}              \\ \hline
\textbf{Name 2} & \multicolumn{2}{l|}{}              \\ \hline
\textbf{Name 3} & \multicolumn{2}{l|}{}              \\ \hline
\end{tabular}
\end{table}

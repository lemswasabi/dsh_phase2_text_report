...
This tells us that we have 5000 duplicate review ids. In order to verify if the duplicate id values and the text values are dependent we sort the dataframe according to the id value as seen if Fig. \ref{fig:id_sort}.
...
\subsection{Performance evaluation with punctuation}
...
\subsection{Grid Search: Base classifiers}

\textcolor{red}{Leminh}

\subsection{Grid Search: Ensemble methods}
